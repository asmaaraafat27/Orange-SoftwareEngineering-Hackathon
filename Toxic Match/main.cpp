...
int main()
{
	...
	//Game Name
	Font font2;
	if (!font2.loadFromFile("Merienda-Bold.ttf"))
	{
		cout << "Error";
	}
	Text GameName;
	GameName.setFont(font2);
	GameName.setString("TOXIC MATCH");
	GameName.setCharacterSize(80);
	GameName.setFillColor(Color::White);
	GameName.setOrigin(-350, -200);
	GameName.setStyle(Text::Bold);
	GameName.setOutlineColor(Color(0, 0, 0, 128));
